...
namespace WebReq_V1.Controllers
{
    public class RequisicaoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Data,ClienteId,SolicitanteId,ProdutoId")] Requisicao requisicao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Data,ClienteId,SolicitanteId,ProdutoId")] Requisicao requisicao)
        {
            if (id != requisicao.Id)
            {
                return NotFound();
